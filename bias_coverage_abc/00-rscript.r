...
tcq({
  INDICES <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/mc.cores.rds")
})
tcq({
  run_parameter_set_method <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/run_parameter_set_method.rds")
})
tcq({
  run_abc_method <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/run_abc_method.rds")
})
tcq({
  params_all <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/params_all.rds")
})
tcq({
  n_runs <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/n_runs.rds")
})
tcq({
  ndays <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/ndays.rds")
})
tcq({
  seeds <- readRDS("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/seeds.rds")
})
...
saveRDS(ans, sprintf("/uufs/chpc.utah.edu/common/home/u1418987/sima/CopyOfSims_calibrate_paper/bias_coverage_abc/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
